...
void main() {
  ...
  testWidgets(
      'a back arrow should be found on RecipeByCategoryConfectionery() page',
          (tester) async {
        await tester.pumpWidget(
            const MaterialApp(home: RecipeByCategoryConfectionery()));
        final value = find.widgetWithIcon(IconButton, Icons.arrow_circle_left_outlined);
        expect(value, findsOneWidget);
      });

  testWidgets(
      'header image should be found on RecipeByCategoryConfectionery() page',
          (tester) async {
        await tester.pumpWidget(
            const MaterialApp(home: RecipeByCategoryConfectionery()));
  ...
  testWidgets(
      'one text widget should be on RecipeByCategoryConfectionery() page',
          (tester) async {
        await tester.pumpWidget(
            const MaterialApp(home: RecipeByCategoryConfectionery()));
