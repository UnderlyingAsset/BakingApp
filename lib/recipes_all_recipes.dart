...
///of the database.  These recipes are shown on tiles which can be scrolled
///through and clicked on to access recipes.


class RecipesAllRecipes extends StatefulWidget {
  const RecipesAllRecipes({super.key});

  @override
  State<RecipesAllRecipes> createState() => _RecipesAllRecipesState();
}

class _RecipesAllRecipesState extends State<RecipesAllRecipes> {

  //This will eventually be a list of documents from the database.
  List<String> docId = [];

  //A method which is used to collect the document IDs of all recipes.
