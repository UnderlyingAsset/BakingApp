...
///A class which returns a list of all recipes a user has submitted that
///are contained within the Recipes collection of the database.  These
///recipes are shown on tiles which can be scrolled through and clicked
///on to access recipes.


class UsersRecipes extends StatefulWidget {
  const UsersRecipes({super.key});

  @override
  State<UsersRecipes> createState() => _UsersRecipesState();
}

class _UsersRecipesState extends State<UsersRecipes> {

  //This will eventually be a list of documents from the database.
  List<String> docId = [];

  //Method to collect docId for all recipes submitted by the currently
  //signed-in user.
